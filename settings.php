...
<body>
    ...
    <main class="main-content">
        <div class="form-box">
            ...
            <form method="post" autocomplete="off">
                ...
                <label>Tax %</label>
                <input type="number" step="0.01" min="0" name="tax" value="<?= s('tax_percent', $sets) ?>"
                    placeholder="0">

                <label>Late-return fee (per day)</label>
                <input type="number" step="0.01" min="0" name="late_fee" value="<?= s('late_fee', $sets) ?>"
                    placeholder="0">
    ...
    <footer>
        ...
        <div class="socials">
            <a href="https://www.facebook.com/thomasbhattrai " target="_blank"><ion-icon
                    name="logo-facebook"></ion-icon></a>
            <a href="https://x.com/" target="_blank"><ion-icon name="logo-twitter"></ion-icon></a>
            <a href="https://www.instagram.com/swostimakaju/ " target="_blank"><ion-icon
